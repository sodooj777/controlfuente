...
class GerenciaController extends Controller
{
    ...
    public function index(Request $request)
    {
           ...
           return view('desarrollo.search',["f1"=>$f1,"f2"=>$f2])->with('solicitudes',$solicitudes);
    ...
    public function edit(string $id)
    {
       ...
       if($solicitu->estatus == 'Cerrado'){
           ...
           return view('desarrollo.edit2')->with('solicitud',$solicitud)->with('solicitudes',$solicitudes)->with('solicitu',$solicitu);
   
       }else{

           return view('desarrollo.edit')->with('solicitud',$solicitud)->with('solicitudes',$solicitudes)->with('solicitu',$solicitu);
